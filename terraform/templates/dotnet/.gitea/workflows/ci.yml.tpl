      ...
      - name: Deploy to Kubernetes
        ...
        run: |
          ...
          if [ -z "$KUBE_CONFIG" ]; then
            echo "ERROR: secrets.KUBE_CONFIG is empty — add repository secret in Gitea"
            echo "  base64 of terraform/.generated/kubeconfig-local-runner"
            exit 1
          fi
          ...
          ./kubectl -n "$k8s_ns" rollout status "deployment/$${{ env.IMAGE_NAME }}" --timeout=120s
